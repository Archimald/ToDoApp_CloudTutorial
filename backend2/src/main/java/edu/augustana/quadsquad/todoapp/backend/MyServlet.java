...
package edu.augustana.quadsquad.todoapp.backend;
...
public class MyServlet extends HttpServlet {
    static Logger Log = Logger.getLogger("edu.augustana.quadsquad.todoapp.backend.MyServlet");
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        Firebase firebase = new Firebase("https://luminous-torch-1060.firebaseio.com/todoItems");
        firebase.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                try {
                    ...
                    msg.setFrom(new InternetAddress("nagger@FIREBASE-TUTORIAL-1267.appspotmail.com",
                            "Todo Nagger"));
                    msg.addRecipient(Message.RecipientType.TO,
                            new InternetAddress("michaelcurrie12@augustana.edu", "Recipient"));
